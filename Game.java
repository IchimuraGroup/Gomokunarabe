...
//                    int count8 = searchConnectCount(0, status, board, x, y, new int[]{-1, 1});//斜め左上方向
                    int count1 = searchConnectCount(0, status, board, x, y, new int[]{0, 1});//右方向
                    int count2 = searchConnectCount(0, status, board, x, y, new int[]{1, -1});//斜め右下方向
                    int count3 = searchConnectCount(0, status, board, x, y, new int[]{0, -1});//下方向
                    int count4 = searchConnectCount(0, status, board, x, y, new int[]{-1, -1});//斜め左下方向
                    int count5 = searchConnectCount(0, status, board, x, y, new int[]{-1, 0});//左方向
